...
export namespace Provider {
  function getLog(context: ProviderContext) {
  ...
  export class ProviderService {
    ...
    constructor(context: ProviderContext, simpleProvider?: SimpleProvider) {
      this.simpleProvider = simpleProvider
      this._promise = this.init(context)
    }

    bind(context: ProviderContext) {
    ...
    private async init(context: ProviderContext) {
